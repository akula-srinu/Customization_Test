-- *******************************************************************************
-- FileName:             NVWB_BEN_Assignments_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_BEN_Assignments_Vsat_FK.lst file

@utlspon NVWB_BEN_Assignments_Vsat_FK
...
INSERT INTO n_join_key_templates(
  ...
  WHERE t.view_label               = 'HR_Emp_Info'
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'BEN_Assignments_Vsat'
    AND t.key_name                 = 'ROWID_FK_EMP'),
      1,
      'EMP$HR_Emp_Info',
      null,
      'nemuser',
