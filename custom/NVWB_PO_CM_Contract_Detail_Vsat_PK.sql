-- *******************************************************************************
-- FileName:             NVWB_PO_CM_Contract_Detail_Vsat_PK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PO_CM_Contract_Detail_Vsat_PK.lst file

@utlspon NVWB_PO_CM_Contract_Detail_Vsat_PK
...
INSERT INTO n_join_key_templates(
      ...
      'COL_ID_CONT_ID_PK',
      'Primary key based on Contract_ID.',
      'NONE',
      'PK',
      'COL',
      null,
