...
-- File Name: QA_NMR_Detail_Vsat_Proj_u2.sql
--
...
@utlspon QA_NMR_Detail_Vsat_Proj_u2
...
and key.key_name = 'PK_NMR_DET_PID' ;
...
values
  ('QA_NMR_Detail_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Projects' and key_name = 'PK_NMR_DET_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_NMR_DET_PID' ;
