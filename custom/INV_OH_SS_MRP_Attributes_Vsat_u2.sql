...
values
  ('INV_OH_SS_MRP_Attributes_Vsat',
   'PK_IN_ITEM_PID',
   'INV_OH_SS_MRP_Attributes_Vsat view Primary Key for column_based join relation ships.',
   '',
   'PK',
   'COL',
   '',
...
and key.view_label = 'INV_OH_SS_MRP_Attributes_Vsat'
and key.key_name = 'PK_IN_ITEM_PID' ;
...
values
  ('INV_Items_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'INV_OH_SS_MRP_Attributes_Vsat' and key_name = 'PK_IN_ITEM_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_IN_ITEM_PID' ;
