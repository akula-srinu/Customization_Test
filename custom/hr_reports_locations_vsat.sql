-- File Name: hr_reports_locations_vsat_u2.sql
--
-- Date Created: 30-09-2014
--
-- Purpose: Addition of Columns to the existing view hr_reports_locations_vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon hr_reports_locations_vsat_u2
  ...
  (VIEW_LABEL,
   ...
   VERSION_ID)
values
  ('HR_Reports_Locations_Vsat',
   'PK_LOC',
   'HR_Reports_Locations_Vsat view Primary Key for column_based join relation ships.',
   '',
   'PK',
   'COL',
   '',
...
and col.column_label = 'Location'
and key.view_label = 'HR_Reports_Locations_Vsat'
and key.key_name = 'PK_LOC' ;
