-- File Name: OE_RMA_Line_Details_Vsat_Scs_Base_u2.sql
--
...
@utlspon OE_RMA_Line_Details_Vsat_Scs_Base_u2
...
and key.key_name = 'PK_ORD_LINE_PCID' ;
...
values
  ('OE_RMA_Line_Details_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'OKS_Scs_Base_Data_Vsat' and key_name = 'PK_ORD_LINE_PCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORD_LINE_PCID' ;
