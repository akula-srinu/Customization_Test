-- *******************************************************************************
-- FileName:             NVWB_OKS_Scs_Base_Data_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_OKS_Scs_Base_Data_Vsat_FK.lst file

@utlspon NVWB_OKS_Scs_Base_Data_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'OKS_Scs_Base_Data_Vsat'
