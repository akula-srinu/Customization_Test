-- *******************************************************************************
-- FileName:             NVWB_GL_Je_Lines_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_GL_Je_Lines_Vsat_FK.lst file

@utlspon NVWB_GL_Je_Lines_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
  ...
  WHERE t.view_label               = 'GL_Je_Lines_Vsat'
