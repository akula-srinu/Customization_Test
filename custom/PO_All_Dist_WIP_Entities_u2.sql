...
-- File Name: PO_All_Dist_WIP_Entities_u2.sql
--
-- Date Created: 28-12-2015
--
-- Purpose: Creating a custom join between PO_All_Distribution_Vsat and WIP_All_Jobs Views.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon PO_All_Dist_WIP_Entities_u2
...
values
  ('WIP_All_Jobs',
   'PK_PO_DIST_ENTITY_PID',
   'WIP_All_Jobs view Primary Key for column_based join relation ships. Viasat Custom Join',
   '',
   'PK',
   'COL',
   '',
...
and col.column_label = 'WIP_Entity_ID'
and key.view_label = 'WIP_All_Jobs'
and key.key_name = 'PK_PO_DIST_ENTITY_PID' ;
...
values
  ('PO_All_Distribution_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'WIP_All_Jobs' and key_name = 'PK_PO_DIST_ENTITY_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_PO_DIST_ENTITY_PID' ;
