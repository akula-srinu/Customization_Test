-- *******************************************************************************
-- FileName:             NVWB_CSI_Instances_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_CSI_Instances_FK.lst file

@utlspon NVWB_CSI_Instances_FK
...
INSERT INTO n_join_key_col_templates(
  ...
  WHERE t.view_label               = 'CSI_Instances'
    AND t.key_name                 = 'COL_ID_FK_REP_LINE_INST'),
      1,
      'Repair_Line_ID',
      null,
      'nemuser',
