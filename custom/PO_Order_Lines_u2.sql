...
and key.key_name = 'PK_ORDER_PID_1' ;
...
values
  ('PO_All_Orders_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PO_All_Lines_Vsat' and key_name = 'PK_ORDER_PID_1'),
   '*',
   '',
   'Y',
   '',
