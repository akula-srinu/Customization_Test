-- *******************************************************************************
-- FileName:             NVWB_PO_ISupplier_Users_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PO_ISupplier_Users_Vsat_FK.lst file

@utlspon NVWB_PO_ISupplier_Users_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'PO_ISupplier_Users_Vsat'
    AND t.key_name                 = 'ROWID_FK_ASA'),
      1,
      'ASA$PO_Vendors',
      null,
      'nemuser',
