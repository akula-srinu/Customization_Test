@utlspon PO_Line_Locations_Distributions_u2
...
and key.key_name = 'PK_LINE_LOC_PID_1' ;
...
values
  ('PO_All_Shipments',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PO_All_Distribution_Vsat' and key_name = 'PK_LINE_LOC_PID_1'),
   '*',
   '',
   'Y',
   '',
