-- File Name: OE_RMA_Line_Details_Vsat_Proj_u2.sql
--
...
@utlspon OE_RMA_Line_Details_Vsat_Proj_u2
...
and key.key_name = 'PK_RMA_LINE_PID' ;
...
values
  ('OE_RMA_Line_Details_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Projects' and key_name = 'PK_RMA_LINE_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_RMA_LINE_PID' ;
