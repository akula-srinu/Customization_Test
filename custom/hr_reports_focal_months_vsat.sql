-- File Name: hr_reports_focal_months_vsat_u2.sql
--
-- Date Created: 30-09-2014
--
-- Purpose: Addition of Columns to the existing view hr_reports_focal_months_vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon hr_reports_focal_months_vsat_u2
...
and col.column_label = 'Lookup_Code'
and key.view_label = 'HR_Reports_Focal_Months_Vsat'
and key.key_name = 'PK_FM' ;
