-- *******************************************************************************
-- FileName:             NVWB_CSD_WIP_Repair_Jobs_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_CSD_WIP_Repair_Jobs_FK.lst file

@utlspon NVWB_CSD_WIP_Repair_Jobs_FK
...
SET DEFINE OFF;
WHENEVER SQLERROR EXIT 1118;

UPDATE n_join_key_templates
   SET view_label = 'CSD_WIP_Repair_Jobs',
       ...
       last_update_date = TO_DATE('2017-01-16 02:25:17','YYYY-MM-DD HH24:MI:SS')
 WHERE t_join_key_id = 457;
