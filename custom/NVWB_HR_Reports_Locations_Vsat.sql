-- *******************************************************************************
-- FileName:             NVWB_HR_Reports_Locations_Vsat.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_HR_Reports_Locations_Vsat.lst file

@utlspon NVWB_HR_Reports_Locations_Vsat
...
INSERT INTO n_view_templates(
      ...
      'Reporting locations',
      null,
      'This view returns the reporting locations.',
      null,
      '%',
      'Y',
      'Y',
...
INSERT INTO n_view_where_templates(
      ...
      1.0,
      5.0,
      'and p.name = ''VSAT_ENG_RPT_LOCATIONS''',
      null,
      null,
      'Y',
      'Y',
