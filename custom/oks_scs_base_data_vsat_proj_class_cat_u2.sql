-- File Name: OKS_Scs_Base_Data_Vsat_Proj_Class_cat_u2.sql
--
...
@utlspon OKS_Scs_Base_Data_Vsat_Class_cat_u2
...
and key.key_name = 'PK_SCS_BASE_PCCID' ;
...
values
  ('OKS_Scs_Base_Data_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Class_Categories_Vsat' and key_name = 'PK_SCS_BASE_PCCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_SCS_BASE_PCCID' ;
