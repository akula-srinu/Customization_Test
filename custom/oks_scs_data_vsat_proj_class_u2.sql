-- File Name: oks_scs_data_vsat_proj_class_u2.sql
--
...
@utlspon oks_scs_data_vsat_proj_class_u2
...
values
  ('OKS_Scs_Data_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Project_Classes' and key_name = 'PK_SCS_PCID'),
   '*',
   '',
   'Y',
   '',
