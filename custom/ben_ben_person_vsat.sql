-- File Name: BEN_BEN_Person_Vsat_u2.sql
--
-- Date Created: 30-09-2014
--
-- Purpose: Addition of Columns to the existing view BEN_BEN_Person_Vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon BEN_BEN_Person_Vsat_u2
...
values
  ('BEN_Ben_Person_Vsat',
   'PK_PER_PID',
   'BEN_BEN_Person_Vsat view Primary Key for column_based join relation ships.',
   '',
   'PK',
   'COL',
   '',
...
and key.view_label = 'BEN_Ben_Person_Vsat'
and key.key_name = 'PK_PER_PID' ;
