-- File Name: qa_qir_detail_vsat_nmr_u2.sql
--
-- Date Created: 30-01-2015
--
-- Purpose: Addition of Columns and joins to the existing view qa_qir_detail_vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon qa_qir_detail_vsat_nmr_u2
...
and col.column_label = 'QIR_Occurance'
and key.view_label = 'QA_NMR_Detail_Vsat'
and key.key_name = 'PK_QIR_NMR_ID' ;
...
from n_view_column_templates col, n_join_key_templates key
where col.view_label = key.view_label
and col.column_label = 'QIR_Plan_ID'
and key.view_label = 'QA_NMR_Detail_Vsat'
and key.key_name = 'PK_QIR_NMR_ID' ;
...
values
  ('QA_Qir_Detail_Vsat',
   'FK_QIR_NMR_ID',
   'QA_Qir_Detail_Vsat view Foreign Key for column label based join relationships.',
   '',
   'FK',
   'COL',
   'Y',
...
where col.view_label = key.view_label
and col.column_label = 'Qir_Occurance'
and key.view_label = 'QA_Qir_Detail_Vsat'
and key.key_name = 'FK_QIR_NMR_ID' ;
