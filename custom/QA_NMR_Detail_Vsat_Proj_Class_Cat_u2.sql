...
-- File Name: QA_NMR_Detail_Vsat_Proj_Class_Cat_u2.sql
--
...
@utlspon QA_NMR_Detail_Vsat_Proj_Class_Cat_u2
...
and key.key_name = 'PK_NMR_DET_PCCID' ;
...
values
  ('QA_NMR_Detail_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Class_Categories_Vsat' and key_name = 'PK_NMR_DET_PCCID'),
   '*',
   '',
   'Y',
   '',
...
from n_view_column_templates col, n_join_key_templates key
where col.view_label = key.view_label
and col.column_label = 'Nmr_Project_No' 
and key.view_label = 'QA_NMR_Detail_Vsat'
and key.key_name = 'FK_NMR_DET_PCCID' ;
