-- *******************************************************************************
-- FileName:             NVWB_CSD_Repair_Nmr_Details_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_CSD_Repair_Nmr_Details_Vsat_FK.lst file

@utlspon NVWB_CSD_Repair_Nmr_Details_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'CSD_Repair_Nmr_Details_Vsat'
    AND t.key_name                 = 'FK_COL_ID_REP_LINE_NMR'),
      1,
      'Repair_Line_Id',
      null,
      'nemuser',
