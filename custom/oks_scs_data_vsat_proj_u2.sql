-- File Name: OKS_Scs_Data_Vsat_proj_u2.sql
--
-- Date Created: 16-12-2014
--
-- Purpose: Additional joins to the existing view OKS_Scs_Data_Vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon OKS_Scs_Data_Vsat_proj_u2
...
values
  ('OKS_Scs_Data_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Projects' and key_name = 'PK_PROJ_ID'),
   '*',
   '',
   'Y',
   '',
...
from n_view_column_templates col, n_join_key_templates key
where col.view_label = key.view_label
and col.column_label = 'Repair_Order_Project'
and key.view_label = 'OKS_Scs_Data_Vsat'
and key.key_name = 'FK_PROJ_ID' ;
