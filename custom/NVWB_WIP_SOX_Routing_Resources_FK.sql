-- *******************************************************************************
-- FileName:             NVWB_WIP_SOX_Routing_Resources_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_WIP_SOX_Routing_Resources_FK.lst file

@utlspon NVWB_WIP_SOX_Routing_Resources_FK
...
INSERT INTO n_join_key_col_templates(
  ...
  WHERE t.view_label               = 'WIP_SOX_Routing_Resources'
    AND t.key_name                 = 'ROWID_FK_RES'),
      1,
      'RES$BOM_Resources',
      null,
      'NOETIX',
