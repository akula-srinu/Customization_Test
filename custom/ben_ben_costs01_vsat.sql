-- File Name: BEN_BEN_Costs01_Vsat_u2.sql
--
-- Date Created: 30-09-2014
--
-- Purpose: Addition of Columns and joins to the existing view BEN_BEN_Costs01_Vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon BEN_BEN_Costs01_Vsat_u2

      
-- Foreign key column for BEN_BEN_Costs01_Vsat to create col relationships
...
insert into n_join_key_templates
  (VIEW_LABEL,
   ...
   VERSION_ID)
values
  ('BEN_BEN_Costs01_Vsat',
   'FK_ASS_PID01',
   'BEN_BEN_Costs01_Vsat view Foreign Key for column label based join relationships.',
   '',
   'FK',
   'COL',
   'N',
...
and key.view_label = 'BEN_BEN_Costs01_Vsat'
and key.key_name = 'FK_ASS_PID01' ;
