-- *******************************************************************************
-- FileName:             NVWB_PO_On_Hold_Invoices.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PO_On_Hold_Invoices.lst file

@utlspon NVWB_PO_On_Hold_Invoices
...
UPDATE n_view_column_templates
   SET view_label = 'PO_On_Hold_Invoices',
       query_position = 1.0,
...
UPDATE n_view_column_templates
   SET view_label = 'PO_On_Hold_Invoices',
       ...
       column_position = 20.0,
       column_type = 'EXPR',
       description = 'PO Functional (base) currency value of PO_Unit_Price: Unit price for the line. Do not summarize on this field.  It may be duplicated. Field modified by Zensar for Viasat security requirements.',
       ref_application_label = null,
       ref_table_name = null,
       key_view_label = null,
       ref_lookup_column_name = null,
