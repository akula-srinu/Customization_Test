-- *******************************************************************************
-- FileName:             NVWB_BOM_Assemblies_PK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_BOM_Assemblies_PK.lst file

@utlspon NVWB_BOM_Assemblies_PK
...
INSERT INTO n_join_key_templates(
      ...
      'BOM_Assemblies',
      'COL_ID_ITEM',
      'PK column based inventory items.',
      'NONE',
      'PK',
      'COL',
      null,
