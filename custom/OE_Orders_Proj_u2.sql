...
-- File Name: OE_Orders_Proj_u2.sql
--
...
values
  ('OE_Orders',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Projects' and key_name = 'PK_ORDER_PID'),
   '*',
   '',
   'Y',
   '',
