-- File Name: OE_Lines_Proj_Class_Cat_u2.sql
--
-- Date Created: 16-01-2015
--
-- Purpose: Addition of Columns and joins to the existing view PA_Class_Categories_Vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon OE_Lines_Proj_Class_Cat_u2
...
and key.key_name = 'PK_ORDER_LINE_PCCID' ;
...
values
  ('OE_Lines',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Class_Categories_Vsat' and key_name = 'PK_ORDER_LINE_PCCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORDER_LINE_PCCID' ;
