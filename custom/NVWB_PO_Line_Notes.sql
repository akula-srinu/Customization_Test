-- *******************************************************************************
-- FileName:             NVWB_PO_Line_Notes.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PO_Line_Notes.lst file

@utlspon NVWB_PO_Line_Notes
...
SET DEFINE OFF;
WHENEVER SQLERROR EXIT 1094;

UPDATE n_view_column_templates
   SET view_label = 'PO_Line_Notes',
       query_position = 2.0,
       column_label = 'Line_Unit_Price',
       table_alias = null,
       ...
       column_position = 49.0,
       column_type = 'EXPR',
       description = 'Unit price for the line in the entered/functional currency. Field modified by Zensar for Viasat security requirements.',
...
UPDATE n_view_column_templates
   SET view_label = 'PO_Line_Notes',
       query_position = 2.0,
       column_label = 'Line_Unit_Price_Base',
       table_alias = null,
       ...
       column_position = 50.0,
       column_type = 'EXPR',
       description = 'PO Functional (base) currency value of Line_Unit_Price: Unit price for the line. Field modified by Zensar for Viasat secuirty requirements.',
       ref_application_label = null,
       ref_table_name = null,
       key_view_label = null,
       ref_lookup_column_name = null,
