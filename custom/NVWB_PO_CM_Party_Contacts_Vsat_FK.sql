-- *******************************************************************************
-- FileName:             NVWB_PO_CM_Party_Contacts_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PO_CM_Party_Contacts_Vsat_FK.lst file

@utlspon NVWB_PO_CM_Party_Contacts_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'PO_CM_Party_Contacts_Vsat'
    AND t.key_name                 = 'COL_ID_CONT_ID_FK_PARTY_CONT'),
      1,
      'Contract_Id',
      null,
      'nemuser',
