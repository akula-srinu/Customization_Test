-- *******************************************************************************
-- FileName:             NVWB_QA_Car_Detail_Vsat_PK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_QA_Car_Detail_Vsat_PK.lst file

@utlspon NVWB_QA_Car_Detail_Vsat_PK
...
INSERT INTO n_join_key_templates(
      ...
      'QA_Car_Detail_Vsat',
      'PK_CAR_OCCURRENCE',
      'Primary key based on OCCURRENCE column.',
      'NONE',
      'PK',
      'COL',
      null,
...
INSERT INTO n_join_key_templates(
      ...
      'QA_Car_Detail_Vsat',
      'PK_CAR_DET_OCCURRENCE',
      'Primary key column on CAR_DET_OCCURRENCE.',
      'NONE',
      'PK',
      'COL',
      null,
