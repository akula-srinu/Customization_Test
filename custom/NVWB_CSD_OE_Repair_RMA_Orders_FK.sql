-- *******************************************************************************
-- FileName:             NVWB_CSD_OE_Repair_RMA_Orders_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_CSD_OE_Repair_RMA_Orders_FK.lst file

@utlspon NVWB_CSD_OE_Repair_RMA_Orders_FK
...
SET DEFINE OFF;
WHENEVER SQLERROR EXIT 1277;

UPDATE n_join_key_templates
   SET view_label = 'CSD_OE_Repair_RMA_Orders',
       ...
       last_update_date = TO_DATE('2016-11-08 00:20:16','YYYY-MM-DD HH24:MI:SS')
 WHERE t_join_key_id = 448;
