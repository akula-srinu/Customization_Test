-- File Name: OE_Lines_Details_Proj_Class_Cat_u2.sql
--
...
@utlspon OE_Lines_Details_Proj_Class_Cat_u2
...
and key.key_name = 'PK_ORD_LINE_DET_PCCID' ;
...
values
  ('OE_Line_Details',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Class_Categories_Vsat' and key_name = 'PK_ORD_LINE_DET_PCCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORD_LINE_DET_PCCID' ;
