-- File Name: hr_emp_assign_hist_si_type_u2.sql
--
...
@utlspon hr_emp_assign_hist_si_type_u2
...
and key.view_label = 'HR_Emp_Assign_Hist'
and key.key_name = 'PK_Emp_Asg_Hist' ;
...
values
  ('HR_SI_Type',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'HR_Emp_Assign_Hist' and key_name = 'PK_Emp_Asg_Hist'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_Emp_Asg_Hist' ;
