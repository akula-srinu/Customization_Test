...
@utlspon oke_deliverable_po_pay_dtl_query
--
--SQL Statement which produced this data:
--  select * from n_view_query_templates where  view_label like 'OKE_Deliverable_PO_Pay_Dtl'
--
Insert into N_VIEW_QUERY_TEMPLATES
 ...
 Values
   ('OKE_Deliverable_PO_Pay_Dtl', 1, NULL, 'N', NULL, 
    '%', NULL, 'Rvattikonda', TO_DATE('07/15/2008 04:23:00', 'MM/DD/YYYY HH24:MI:SS'), 'pvemuru', 
