@utlspon PO_Lines_Line_Locations_u2
...
and key.key_name = 'PK_LINE_PID_1' ;
...
values
  ('PO_All_Lines_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PO_All_Shipments' and key_name = 'PK_LINE_PID_1'),
   '*',
   '',
   'Y',
   '',
