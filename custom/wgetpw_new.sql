...
define encrypted_pwd ="NO_Value"

column c_encrypted_pwd new_value encrypted_pwd noprint

select utl_raw.cast_to_raw('&PW')||'###' c_encrypted_pwd from dual;

define pw_&1.=&1./&encrypted_pwd.&TMPOKCONNECTSTRING

undefine encrypted_pwd
