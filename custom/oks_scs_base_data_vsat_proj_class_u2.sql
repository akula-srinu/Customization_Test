-- File Name: oks_scs_base_data_vsat_proj_class_u2.sql
--
-- Date Created: 30-12-2014
--
-- Purpose: Addition of Columns and joins to the existing view OE_SCS_Details.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon oks_scs_base_data_vsat_proj_class_u2
...
and key.key_name = 'PK_SCS_BASE_PCID' ;
...
values
  ('OKS_Scs_Base_Data_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Project_Classes' and key_name = 'PK_SCS_BASE_PCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_SCS_BASE_PCID' ;
