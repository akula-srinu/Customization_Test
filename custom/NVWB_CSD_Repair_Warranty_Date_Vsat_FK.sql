-- *******************************************************************************
-- FileName:             NVWB_CSD_Repair_Warranty_Date_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_CSD_Repair_Warranty_Date_Vsat_FK.lst file

@utlspon NVWB_CSD_Repair_Warranty_Date_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'CSD_Repair_Warranty_Date_Vsat'
    AND t.key_name                 = 'COL_ID_CUST_PROD_ID_FK_WRNTY'),
      1,
      'Customer_Product_ID',
      null,
      'nemuser',
