-- File Name: po_releases_and_rel_distributions_u2.sql
--
...
@utlspon po_releases_and_rel_distributions_u2
...
and key.key_name = 'PK_REL_DISTRIBUTIONS_ID' ;
...
values
  ('PO_Release_Distributions',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PO_Releases' and key_name = 'PK_REL_DISTRIBUTIONS_ID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_REL_DISTRIBUTIONS_ID';
