-- File Name: OE_Shipments_By_Mo_Vsat_Scs_Data_u2.sql
--
...
@utlspon OE_Shipments_By_Mo_Vsat_Scs_Data_u2
...
and col.column_label = 'Order_Num'
and key.view_label = 'OKS_Scs_Data_Vsat'
and key.key_name = 'PK_SHIP_LINE_PID' ;
...
values
  ('OE_Shipments_By_Mo_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'OKS_Scs_Data_Vsat' and key_name = 'PK_SHIP_LINE_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_SHIP_LINE_PID' ;
