-- File Name: hr_reports_cost_centers_vsat_u2.sql
--
-- Date Created: 30-09-2014
--
-- Purpose: Addition of Columns to the existing view hr_reports_cost_centers_vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon hr_reports_cost_centers_vsat_u2
...
values
  ('HR_Reports_Cost_Centers_Vsat',
   'PK_CC',
   'HR_Reports_Cost_Centers_Vsat view Primary Key for column_based join relation ships.',
   '',
   'PK',
   'COL',
   '',
...
and col.column_label = 'Eng_Cost_Center'
and key.view_label = 'HR_Reports_Cost_Centers_Vsat'
and key.key_name = 'PK_CC' ;
