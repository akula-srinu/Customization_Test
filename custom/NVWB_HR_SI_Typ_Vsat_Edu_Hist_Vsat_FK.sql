-- *******************************************************************************
-- FileName:             NVWB_HR_SI_Typ_Vsat_Edu_Hist_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_HR_SI_Typ_Vsat_Edu_Hist_Vsat_FK.lst file

@utlspon NVWB_HR_SI_Typ_Vsat_Edu_Hist_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
  ...
  WHERE t.view_label               = 'HR_SI_Typ_Vsat_Edu_Hist_Vsat'
    AND t.key_name                 = 'ROWID_FK_PERSON_HIST'),
      1,
      'PEO$HR_Person_Hist',
      null,
      'nemuser',
...
INSERT INTO n_join_key_templates(
      ...
      'HR_SI_Typ_Vsat_Edu_Hist_Vsat',
      'FK_Emp_Asg_Hist_SI_Typ_Vsat_Edu_Hist',
      'FK column on emp data.',
      'NONE',
      'FK',
      'COL',
      'Y',
...
INSERT INTO n_join_key_col_templates(
   ...
   FROM n_join_key_templates t
  WHERE t.view_label               = 'HR_SI_Typ_Vsat_Edu_Hist_Vsat'
    AND t.key_name                 = 'FK_Emp_Asg_Hist_SI_Typ_Vsat_Edu_Hist'),
      3,
