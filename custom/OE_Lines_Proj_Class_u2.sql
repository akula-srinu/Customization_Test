-- File Name: OE_Lines_Proj_Class_u2.sql
--
-- Date Created: 30-12-2014
--
-- Purpose: Addition of Columns and joins to the existing view PA_Project_Classes.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon OE_Lines_Proj_Class_u2
...
and key.key_name = 'PK_ORDER_LINE_PCID' ;
...
values
  ('OE_Lines',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Project_Classes' and key_name = 'PK_ORDER_LINE_PCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORDER_LINE_PCID' ;
