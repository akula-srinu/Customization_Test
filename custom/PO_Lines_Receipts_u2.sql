...
and key.key_name = 'PK_LINE_PID_3' ;
...
values
  ('PO_All_Lines_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PO_Receipts_Vsat' and key_name = 'PK_LINE_PID_3'),
   '*',
   '',
   'Y',
   '',
