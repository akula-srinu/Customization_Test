-- File Name: OKS_Scs_Data_Vsat_Proj_Class_Cat_u2.sql
--
...
@utlspon OKS_Scs_Data_Vsat_Proj_Class_Cat_u2
...
values
  ('OKS_Scs_Data_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Class_Categories_Vsat' and key_name = 'PK_SCS_PCCID'),
   '*',
   '',
   'Y',
   '',
