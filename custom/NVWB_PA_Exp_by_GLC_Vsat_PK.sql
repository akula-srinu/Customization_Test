-- *******************************************************************************
-- FileName:             NVWB_PA_Exp_by_GLC_Vsat_PK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PA_Exp_by_GLC_Vsat_PK.lst file

@utlspon NVWB_PA_Exp_by_GLC_Vsat_PK
...
INSERT INTO n_join_key_col_templates(
  ...
  WHERE t.view_label               = 'PA_Exp_by_GLC_Vsat'
    AND t.key_name                 = 'ROWID_PK'),
      1,
      'EXPI$PA_Exp_by_GLC_Vsat',
      null,
      'NOETIX',
      '6.3 JOIN KEY CONVERSION'
   );
