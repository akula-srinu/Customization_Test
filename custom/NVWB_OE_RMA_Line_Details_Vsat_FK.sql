-- *******************************************************************************
-- FileName:             NVWB_OE_RMA_Line_Details_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_OE_RMA_Line_Details_Vsat_FK.lst file

@utlspon NVWB_OE_RMA_Line_Details_Vsat_FK
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'OE_RMA_Line_Details_Vsat'
    AND t.key_name                 = 'ROWID_FK_LINES'),
      1,
      'LINES$OE_Lines',
      null,
      'nemuser',
...
INSERT INTO n_join_key_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'RA_Customers'
    AND t.key_name                 = 'ROWID_PK'),
      '*',
      null,
      'Y',
