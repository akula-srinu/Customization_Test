-- *******************************************************************************
-- FileName:             NVWB_QA_QAPP_PN_Vsat.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_QA_QAPP_PN_Vsat.lst file

@utlspon NVWB_QA_QAPP_PN_Vsat
...
INSERT INTO n_view_where_templates(
      ...
      1.0,
      3.0,
      'and qr.item_id = msi.inventory_item_id',
      null,
      null,
      'Y',
      'Y',
