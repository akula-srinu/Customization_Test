-- *******************************************************************************
-- FileName:             NVWB_CSI_Ser_Instl_Bse_Info_Vsat_PK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_CSI_Ser_Instl_Bse_Info_Vsat_PK.lst file

@utlspon NVWB_CSI_Ser_Instl_Bse_Info_Vsat_PK
...
INSERT INTO n_join_key_templates(
      ...
      'COLID_OKC_Header_ID',
      'column based join using OKC_Header_ID',
      'NONE',
      'PK',
      'COL',
      null,
...
INSERT INTO n_join_key_templates(
      ...
      'CSI_Ser_Instl_Bse_Info_Vsat',
      'COL_ID_Item_Instance_ID',
      'PK column based on item instance id.',
      'NONE',
      'PK',
      'COL',
      null,
