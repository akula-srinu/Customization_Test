-- *******************************************************************************
-- FileName:             NVWB_WIP_Routings_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_WIP_Routings_FK.lst file

@utlspon NVWB_WIP_Routings_FK
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'WIP_Routings'
    AND t.key_name                 = 'COL_ID_FK_REP_LINE_WIP_ROUT'),
      1,
      'Repair_Line_ID',
      null,
      'nemuser',
