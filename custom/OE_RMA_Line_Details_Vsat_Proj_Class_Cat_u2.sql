-- File Name: OE_RMA_Line_Details_Vsat_Proj_Class_Cat_u2.sql
--
...
@utlspon OE_RMA_Line_Details_Vsat_Proj_Class_Cat_u2
...
values
  ('PA_Rma_Class_Categories_Vsat',
   'PK_RMA_LINE_PCCID',
   'PA_Rma_Class_Categories_Vsat view Primary Key for column_based join relation ships.',
   '',
   'PK',
   'COL',
   '',
...
and key.view_label = 'PA_Rma_Class_Categories_Vsat'
and key.key_name = 'PK_RMA_LINE_PCCID' ;
...
values
  ('OE_RMA_Line_Details_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Rma_Class_Categories_Vsat' and key_name = 'PK_RMA_LINE_PCCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_RMA_LINE_PCCID' ;
