...
--                        (Issue 28846)
--   24-May-13 D Glancy   Move the insert into n_application_owner_templates for all the application_id's 
--                        that are not in metadata in the fnd_application table 
...
--   31-Mar-15 Srinivas   Created backup tables of non-templates for IR, drop triggers.
--   08-Oct-15  Arvind    Added code for n_help% tables and n_application_owner_templates as non supported tables. (Issue: NV-1240)
--   13-Oct-15  Arvind    Addded code to handle the deletes in WB customizations. (Issue: NV-1217)
...
--Creating non-templates backup tables for IR
@n_temp_customizations

start wdrop table   &NOETIX_USER n_view_temp_incr_bkp
start wdrop table   &NOETIX_USER n_view_query_temp_incr_bkp
start wdrop table   &NOETIX_USER n_view_tabtemp_incr_bkp
start wdrop table   &NOETIX_USER n_view_coltemp_incr_bkp
start wdrop table   &NOETIX_USER N_VIEW_WHERE_TEMP_incr_bkp
start wdrop table   &NOETIX_USER n_join_key_temp_incr_bkp
start wdrop table   &NOETIX_USER n_join_key_col_temp_incr_bkp
start wdrop table   &NOETIX_USER n_role_view_temp_incr_bkp
start wdrop table   &NOETIX_USER n_view_proptemp_incr_bkp
--adding non-supported metadata tables for avoiding the errors
start wdrop table   &NOETIX_USER n_role_temp_incr_bkp
start wdrop table   &NOETIX_USER N_ANS_WHERE_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_ANS_TABLE_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_ANS_QUERY_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_ANS_PARAM_VALUE_incr_bkp
start wdrop table   &NOETIX_USER N_ANS_PARAM_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_ANS_COLUMN_TOTAL_incr_bkp
start wdrop table   &NOETIX_USER N_ANS_COLUMN_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_ANSWER_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_GRANT_TABLE_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_VIEW_TABLE_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_SEG_KEY_FLEX_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_ROLE_APPL_XREF_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_PROPERTY_TYPE_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_PROFILE_OPTION_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_PL_FOLDER_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_KFF_STRUCT_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_KFF_PROC_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_KFF_FLEX_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_HELP_QUESTIONS_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_HELP_SEE_OTHER_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_HELP_PROG_XREF_TEMP_incr_bkp
start wdrop table   &NOETIX_USER N_APPL_OWNER_TEMP_INCR_BKP



CREATE TABLE n_view_temp_incr_bkp               as select rowid U_ID, nv.* from n_view_templates nv;
CREATE TABLE n_view_query_temp_incr_bkp         as select rowid U_ID, nv.* from n_view_query_templates nv;
CREATE TABLE n_view_tabtemp_incr_bkp            as select rowid U_ID, nv.* from n_view_table_templates nv;
CREATE TABLE n_view_coltemp_incr_bkp            as select rowid U_ID, nv.* from n_view_column_templates nv;
CREATE TABLE N_VIEW_WHERE_TEMP_incr_bkp         as select rowid U_ID, nv.* from n_view_where_templates nv;
CREATE TABLE n_join_key_temp_incr_bkp           as select rowid U_ID, nv.* from n_join_key_templates nv;
CREATE TABLE n_join_key_col_temp_incr_bkp       as select rowid U_ID, nv.* from n_join_key_col_templates nv;
CREATE TABLE n_role_view_temp_incr_bkp          as select rowid U_ID, nv.* from n_role_view_templates nv;
CREATE TABLE n_view_proptemp_incr_bkp           as select rowid U_ID, nv.* from n_view_property_templates nv;
-- Non-supported metadata tables
CREATE TABLE n_role_temp_incr_bkp               as select rowid U_ID, nv.* from n_role_templates nv;
CREATE TABLE N_ANS_WHERE_TEMP_incr_bkp          as select rowid U_ID, nv.* from N_ANS_WHERE_TEMPLATES nv;
CREATE TABLE N_ANS_TABLE_TEMP_incr_bkp          as select rowid U_ID, nv.* from N_ANS_TABLE_TEMPLATES nv;
CREATE TABLE N_ANS_QUERY_TEMP_incr_bkp          as select rowid U_ID, nv.* from N_ANS_QUERY_TEMPLATES nv;
CREATE TABLE N_ANS_PARAM_VALUE_incr_bkp         as select rowid U_ID, nv.* from N_ANS_PARAM_VALUE_TEMPLATES nv;
CREATE TABLE N_ANS_PARAM_TEMP_incr_bkp          as select rowid U_ID, nv.* from N_ANS_PARAM_TEMPLATES nv;
CREATE TABLE N_ANS_COLUMN_TOTAL_incr_bkp        as select rowid U_ID, nv.* from N_ANS_COLUMN_TOTAL_TEMPLATES nv;
CREATE TABLE N_ANS_COLUMN_TEMP_incr_bkp         as select rowid U_ID, nv.* from N_ANS_COLUMN_TEMPLATES nv;
CREATE TABLE N_ANSWER_TEMP_incr_bkp             as select rowid U_ID, nv.* from N_ANSWER_TEMPLATES nv;
CREATE TABLE N_GRANT_TABLE_TEMP_incr_bkp        as select rowid U_ID, nv.* from N_GRANT_TABLE_TEMPLATES nv;
CREATE TABLE N_VIEW_TABLE_TEMP_incr_bkp         as select rowid U_ID, nv.* from N_VIEW_TABLE_CHANGES_TEMPLATES nv;
CREATE TABLE N_SEG_KEY_FLEX_TEMP_incr_bkp       as select rowid U_ID, nv.* from N_SEG_KEY_FLEXFIELD_TEMPLATES nv;
CREATE TABLE N_ROLE_APPL_XREF_TEMP_incr_bkp     as select rowid U_ID, nv.* from N_ROLE_APPL_XREF_TEMPLATES nv;
CREATE TABLE N_PROPERTY_TYPE_TEMP_incr_bkp      as select rowid U_ID, nv.* from N_PROPERTY_TYPE_TEMPLATES nv;
CREATE TABLE N_PROFILE_OPTION_TEMP_incr_bkp     as select rowid U_ID, nv.* from N_PROFILE_OPTION_TEMPLATES nv;
CREATE TABLE N_PL_FOLDER_TEMP_incr_bkp          as select rowid U_ID, nv.* from N_PL_FOLDER_TEMPLATES nv;
CREATE TABLE N_KFF_STRUCT_TEMP_incr_bkp         as select rowid U_ID, nv.* from N_KFF_STRUCT_IDEN_TEMPLATES nv;
CREATE TABLE N_KFF_PROC_TEMP_incr_bkp           as select rowid U_ID, nv.* from N_KFF_PROCESSING_TEMPLATES nv;
CREATE TABLE N_KFF_FLEX_TEMP_incr_bkp           as select rowid U_ID, nv.* from N_KFF_FLEX_SOURCE_TEMPLATES nv;
--n_help% tables
CREATE TABLE N_HELP_QUESTIONS_TEMP_incr_bkp     as select rowid U_ID, nv.* from N_HELP_QUESTIONS_TEMPLATES nv;
CREATE TABLE N_HELP_SEE_OTHER_TEMP_incr_bkp     as select rowid U_ID, nv.* from N_HELP_SEE_OTHER_TEMPLATES nv;
CREATE TABLE N_HELP_PROG_XREF_TEMP_incr_bkp     as select rowid U_ID, nv.* from N_HELP_PROGRAM_XREF_TEMPLATES nv;
CREATE TABLE N_APPL_OWNER_TEMP_INCR_BKP         as select rowid U_ID, nv.* from N_APPLICATION_OWNER_TEMPLATES nv;
