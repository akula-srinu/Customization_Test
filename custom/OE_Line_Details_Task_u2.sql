-- File Name: OE_Line_Details_Task_u2.sql
--
...
@utlspon OE_Line_Details_Task_u2
...
and key.key_name = 'PK_ORD_LINE_DET_TID' ;
...
values
  ('OE_Line_Details',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Tasks' and key_name = 'PK_ORD_LINE_DET_TID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORD_LINE_DET_TID' ;
