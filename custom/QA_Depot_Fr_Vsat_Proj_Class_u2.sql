...
-- File Name: QA_Depot_Fr_Vsat_Proj_Class_u2.sql
--
-- Date Created: 30-12-2014
--
-- Purpose: Addition of Columns and joins to the existing view QA_Depot_Fr_Vsat.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon QA_Depot_Fr_Vsat_Proj_Class_u2
...
and key.key_name = 'PK_DEPOT_FR_PCID' ;
...
values
  ('QA_Depot_Fr_Vsat',
   'FK_DEPOT_FR_PCID',
   'QA_Depot_Fr_Vsat view Foreign Key for column label based join relationships.',
   '',
   'FK',
   'COL',
   'Y',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Project_Classes' and key_name = 'PK_DEPOT_FR_PCID'),
   '*',
   '',
   'Y',
   '',
...
and key.view_label = 'QA_Depot_Fr_Vsat'
and key.key_name = 'FK_DEPOT_FR_PCID' ;
