-- File Name: QA_NMR_Legacy_Vsat_Proju2.sql
--
...
@utlspon QA_NMR_Legacy_Vsat_Proju2
...
and key.key_name = 'PK_NMR_LEG_PID' ;
...
values
  ('QA_NMR_Legacy_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Projects' and key_name = 'PK_NMR_LEG_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_NMR_LEG_PID' ;
