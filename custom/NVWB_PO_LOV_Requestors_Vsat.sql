-- *******************************************************************************
-- FileName:             NVWB_PO_LOV_Requestors_Vsat.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PO_LOV_Requestors_Vsat.lst file

@utlspon NVWB_PO_LOV_Requestors_Vsat
...
INSERT INTO n_view_where_templates(
      ...
      1.0,
      1.0,
      'AND reql.to_person_id = peo.person_id',
      null,
      null,
      'Y',
      'Y',
