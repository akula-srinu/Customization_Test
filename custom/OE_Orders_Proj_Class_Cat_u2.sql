-- File Name: OE_Orders_Proj_Class_Cat_u2.sql
--
...
@utlspon OE_Orders_Proj_Class_Cat_u2
...
and key.key_name = 'PK_ORDER_PCCID' ;
...
values
  ('OE_Orders',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Class_Categories_Vsat' and key_name = 'PK_ORDER_PCCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORDER_PCCID' ;
