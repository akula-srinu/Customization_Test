-- *******************************************************************************
-- FileName:             NVWB_CSD_Repair_Notes_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_CSD_Repair_Notes_FK.lst file

@utlspon NVWB_CSD_Repair_Notes_FK
...
SET DEFINE OFF;
WHENEVER SQLERROR EXIT 1128;

UPDATE n_join_key_templates
   SET view_label = 'CSD_Repair_Notes',
       ...
       last_update_date = TO_DATE('2017-11-29 03:08:15','YYYY-MM-DD HH24:MI:SS')
 WHERE t_join_key_id = 453;
