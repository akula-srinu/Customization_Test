-- *******************************************************************************
-- FileName:             NVWB_AP_Inv_Dist_Essentials.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_AP_Inv_Dist_Essentials.lst file

@utlspon NVWB_AP_Inv_Dist_Essentials
...
SET DEFINE OFF;
WHENEVER SQLERROR EXIT 915;

UPDATE n_view_column_templates
   SET view_label = 'AP_Inv_Dist_Essentials',
       query_position = 4.0,
