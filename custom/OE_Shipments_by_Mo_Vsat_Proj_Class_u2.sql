-- File Name: OE_Shipments_by_Mo_Vsat_Proj_Class_u2.sql
--
...
@utlspon OE_Shipments_by_Mo_Vsat_Proj_Class_u2
...
and key.key_name = 'PK_OE_SHIP_PCID' ;
...
values
  ('OE_Shipments_By_Mo_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Project_Classes' and key_name = 'PK_OE_SHIP_PCID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_OE_SHIP_PCID' ;
