...
-- File Name: OE_Order_Lines_Proj_u2.sql
--
...
and key.key_name = 'PK_ORDER_LINE_PID' ;
...
values
  ('OE_Lines',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Projects' and key_name = 'PK_ORDER_LINE_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORDER_LINE_PID' ;
