-- *******************************************************************************
-- FileName:             NVWB_PO_RTO_Receipts_Vsat_FK.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PO_RTO_Receipts_Vsat_FK.lst file

@utlspon NVWB_PO_RTO_Receipts_Vsat_FK
...
INSERT INTO n_join_key_templates(
      ...
      'COL_ID_FK_REP_LINE',
      'Foreign key column based on repair line id.',
      'NONE',
      'FK',
      'COL',
      'Y',
...
INSERT INTO n_join_key_col_templates(
      ...
      (SELECT t.t_join_key_id
   FROM n_join_key_templates t
  WHERE t.view_label               = 'PO_RTO_Receipts_Vsat'
