...
-- File Name: PO_All_Orders_Vsat_Vendors_u2.sql
--
-- Date Created: 29-02-2016
--
-- Purpose: Creating Joins between PO All Orders to PO Vendors views.
--
-- Requested By: Viasat.
--
-- Versions:
...
@utlspon PO_All_Orders_Vsat_Vendors_u2
...
and key.key_name = 'PK_ORDER_SUPP_PID' ;
...
values
  ('PO_Vendors',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PO_All_Orders_Vsat' and key_name = 'PK_ORDER_SUPP_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORDER_SUPP_PID' ;
