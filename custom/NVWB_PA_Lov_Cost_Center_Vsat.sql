-- *******************************************************************************
-- FileName:             NVWB_PA_Lov_Cost_Center_Vsat.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_PA_Lov_Cost_Center_Vsat.lst file

@utlspon NVWB_PA_Lov_Cost_Center_Vsat
...
INSERT INTO n_view_where_templates(
      ...
      1.0,
      1.0,
      'AND task.carrying_out_organization_id = org.organization_id',
      null,
      null,
      'Y',
      'N',
