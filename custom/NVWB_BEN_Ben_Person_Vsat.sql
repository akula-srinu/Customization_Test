-- *******************************************************************************
-- FileName:             NVWB_BEN_Ben_Person_Vsat.sql
--
...
--
-- *******************************************************************************
-- output to NVWB_BEN_Ben_Person_Vsat.lst file

@utlspon NVWB_BEN_Ben_Person_Vsat
...
INSERT INTO n_view_where_templates(
      ...
      1.0,
      2.0,
      'and BPIL.per_in_ler_stat_cd IN (''PROCD'', ''STRTD'')',
      null,
      null,
      'Y',
      'Y',
...
INSERT INTO n_view_where_templates(
      ...
      1.0,
      1.0,
      'AND emp.person_id = BPIL.person_id',
      null,
      null,
      'Y',
      'Y',
