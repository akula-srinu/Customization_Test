@utlspon PO_Order_Distributions_u2
...
and key.key_name = 'PK_ORDER_PID_3' ;
...
values
  ('PO_All_Orders_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PO_All_Shipments' and key_name = 'PK_ORDER_PID_3'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_ORDER_LIN_LOC_PID_2' ;
