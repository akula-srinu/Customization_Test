-- File Name: OKS_Scs_Data_Vsat_task_u2.sql
--
...
@utlspon OKS_Scs_Data_Vsat_task_u2
...
values
  ('OKS_Scs_Data_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Tasks' and key_name = 'PK_TASK_ID'),
   '*',
   '',
   'Y',
   '',
...
from n_view_column_templates col, n_join_key_templates key
where col.view_label = key.view_label
and col.column_label = 'Repair_Order_Task'
and key.view_label = 'OKS_Scs_Data_Vsat'
and key.key_name = 'FK_TASK_ID' ;
