...
-- File Name: QA_Depot_Fr_Vsat_Proj_u2.sql
--
...
@utlspon QA_Depot_Fr_Vsat_Proj_u2
...
and key.key_name = 'PK_DEPOT_FR_PID' ;
...
values
  ('QA_Depot_Fr_Vsat',
   ...
   '',
   'N',
   (SELECT T_JOIN_KEY_ID FROM N_JOIN_KEY_TEMPLATES where view_label = 'PA_Projects' and key_name = 'PK_DEPOT_FR_PID'),
   '*',
   '',
   'Y',
   '',
...
and key.key_name = 'FK_DEPOT_FR_PID' ;
